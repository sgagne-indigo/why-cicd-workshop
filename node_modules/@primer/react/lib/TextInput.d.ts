...
declare const _default: PolymorphicForwardRefComponent<"input", TextInputProps> & {
    Action: React.ForwardRefExoticComponent<Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, "aria-label" | "size"> & {
    ...
    } & import("./sx").SxProp & React.RefAttributes<HTMLButtonElement>>;
};
